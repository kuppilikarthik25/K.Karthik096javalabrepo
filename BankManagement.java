class Account 
{
 ...
 Account(int n, double b, String t) { accNumber=n; balance=b; accType=t; 
 }
...
class SavingsAccount extends Account
 ...
 super(n,b,"Savings"); rate=r;  }
 void calculateInterest() {double i=balance*rate/100;  System.out.println("Interest: "+i);  balance+=i; 
 }}
class CurrentAccount extends Account {
 private double overdraft;
 CurrentAccount(int n, double b, double o)  { 
 super(n,b,"Current"); overdraft=o; }
 void withdraw(double amt) {
